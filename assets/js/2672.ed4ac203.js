...
/* harmony import */ var _debounce_c13afd3e_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(30528);
...
/* harmony import */ var _grid_cfa3c02f_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(75673);
...
const DyteGrid = class {
  constructor(hostRef) {
    ...
    this.gap = 8;
    this.size = undefined;
    this.states = _store_01c79590_js__WEBPACK_IMPORTED_MODULE_6__.s;
  ...
  screenShareParticipantsChanged(participants) {
    ...
    if (!!_store_01c79590_js__WEBPACK_IMPORTED_MODULE_6__.s.activeScreenShare === activeScreenShare)
      return;
    this.stateUpdate.emit({ activeScreenShare });
    _store_01c79590_js__WEBPACK_IMPORTED_MODULE_6__.s.activeScreenShare = activeScreenShare;
  }
  pluginsChanged(plugins) {
    const activePlugin = plugins.length > 0;
    if (!!_store_01c79590_js__WEBPACK_IMPORTED_MODULE_6__.s.activePlugin === activePlugin)
      return;
    this.stateUpdate.emit({ activePlugin });
    _store_01c79590_js__WEBPACK_IMPORTED_MODULE_6__.s.activePlugin = activePlugin;
  }
  pinnedParticipantsChanged(participants) {
    const activeSpotlight = participants.length > 0;
    if (!!_store_01c79590_js__WEBPACK_IMPORTED_MODULE_6__.s.activeSpotlight === activeSpotlight)
      return;
    this.stateUpdate.emit({ activeSpotlight });
    _store_01c79590_js__WEBPACK_IMPORTED_MODULE_6__.s.activeSpotlight = activeSpotlight;
  }
  ...
  render() {
    const defaults = {
      ...
      size: this.size,
      states: this.states || _store_01c79590_js__WEBPACK_IMPORTED_MODULE_6__.s,
      config: this.config,
    ...
    if (!this.meetingConnected && this.hideSelf && !(0,_livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_7__.a)(this.meeting)) {
      return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "offline-grid" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('stage.reconnecting'))));
    }
    ...
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b65e08b5_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-grid", defaults: defaults, childProps: {
