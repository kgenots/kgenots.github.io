...
/* harmony import */ var _clone_e2a39cf9_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5172);
/* harmony import */ var _cloneDeep_6a74a147_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(53001);
/* harmony import */ var _keysIn_8bf552ee_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(34166);
/* harmony import */ var _isObjectLike_0d1a05d5_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9079);
...
const DyteAiTranscriptions = class {
  ...
  connectedCallback() {
    var _a, _b, _c, _d;
    this.transcriptions = (0,_clone_e2a39cf9_js__WEBPACK_IMPORTED_MODULE_3__.c)((_b = (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.ai) === null || _b === void 0 ? void 0 : _b.transcripts);
    this.transcriptions = this.transcriptions.reduce(this.transcriptionsReducer, []);
    (_d = (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.ai) === null || _d === void 0 ? void 0 : _d.on('transcript', (data) => {
      this.transcriptions = this.transcriptionsReducer(this.transcriptions, data);
    });
  }
  disconnectedCallback() {
    var _a, _b;
    (_b = (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.ai) === null || _b === void 0 ? void 0 : _b.off('transcript', (data) => {
      this.transcriptions = this.transcriptionsReducer(this.transcriptions, data);
    });
  }
