...
/* harmony import */ var _config_784a655d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(57492);
/* harmony import */ var _size_d48d31c8_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9245);
/* harmony import */ var _index_a35e3c03_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46677);
/* harmony import */ var _default_ui_config_f87e0ba7_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(71783);
...
/* harmony import */ var _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(99126);
/* harmony import */ var _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(36677);
/* harmony import */ var _default_icon_pack_307ffa7c_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(48724);
/* harmony import */ var _keysIn_8bf552ee_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(34166);
/* harmony import */ var _isObjectLike_0d1a05d5_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9079);
/* harmony import */ var _breakout_rooms_34bb7ea2_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(52732);
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.roomJoinedListener = () => {
      ...
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'joined';
    };
    ...
    this.waitlistedListener = () => {
      ...
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'waiting';
    };
    this.roomLeftListener = ({ state: state$1 }) => {
      const states = this.states || _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s;
      if ((states === null || states === void 0 ? void 0 : states.roomLeftState) === 'disconnected') {
        this.setStates({ meeting: 'ended', roomLeftState: state$1 });
        _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'ended';
        return;
      }
      this.setStates({ meeting: 'ended', roomLeftState: state$1 });
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'ended';
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.roomLeftState = state$1;
    };
    this.mediaPermissionUpdateListener = ({ kind, message }) => {
      if (['audio', 'video'].includes(kind)) {
        if (message === 'ACCEPTED' || _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.activeDebugger)
          return;
        ...
        _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.activePermissionsMessage = permissionModalSettings;
      }
    };
    this.joinStateAcceptedListener = () => {
      this.setStates({ activeJoinStage: true });
      this.stateUpdate.emit({ activeJoinStage: true });
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.activeJoinStage = true;
    };
    ...
    this.states = {
      meeting: 'idle',
      prefs: (0,_user_prefs_f52d234f_js__WEBPACK_IMPORTED_MODULE_7__.g)(),
    };
    this.newMeeting = undefined;
    this.iconPack = _default_icon_pack_307ffa7c_js__WEBPACK_IMPORTED_MODULE_10__.d;
  }
  connectedCallback() {
    var _a;
    ...
    if (this.applyDesignSystem &&
      ...
      (0,_config_784a655d_js__WEBPACK_IMPORTED_MODULE_1__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_784a655d_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      ...
      if (meeting.connectedMeetings.supportsConnectedMeetings &&
        ((_a = _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.activeBreakoutRoomsManager) === null || _a === void 0 ? void 0 : _a.destinationMeetingId)) {
    ...
    if (meeting.self.roomJoined) {
      ...
      if (this.showSetupScreen && this.newMeeting == null) {
        ...
        _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.meeting = 'setup';
      }
      else {
  ...
  handleChangingMeeting(destinationMeetingId) {
    _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.activeBreakoutRoomsManager = Object.assign(Object.assign({}, _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.activeBreakoutRoomsManager), { destinationMeetingId });
  }
  handleResize() {
  ...
  setStates(states) {
    ...
    (0,_config_784a655d_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
  ...
  render() {
    ...
    const defaults = {
      ...
      size: this.size,
      states: this.states || _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s,
      config: this.config,
...
/* harmony export */ });
/* harmony import */ var _default_icon_pack_307ffa7c_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48724);
