...
function parseRichText(text) {
  ...
  text = text
    ...
    if (linkPattern.test(word)) {
      ...
      return word.replace(res[0], `<a class="link" href="${res[0]}" target="_blank" rel="noopener noreferrer">${res[0]}</a>`);
    }
    return word;
  })
    .join(' ');
...
/* harmony import */ var _TextMessage_c7bde1d4_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2515);
/* harmony import */ var _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(51285);
...
const DyteChat = class {
  constructor(hostRef) {
    ...
    this.isPrivateChatSupported = () => {
      var _a, _b, _c;
      return (!(0,_flags_33c46e09_js__WEBPACK_IMPORTED_MODULE_5__.u)(this.meeting) &&
    ...
    this.config = _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_7__.d;
    this.size = undefined;
