...
const DyteTextMessageView = class {
  ...
  render() {
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: { text: true, emoji: (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.text) } }, this.isMarkdown ? (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-markdown-view", { text: this.text }) : this.text));
  }
};
