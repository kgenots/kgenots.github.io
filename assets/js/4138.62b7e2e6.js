...
/* harmony import */ var _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(51285);
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.config = _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_4__.d;
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_1d735a37_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      if (this.config === _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_4__.d) {
  ...
  setStates(states) {
    ...
    (0,_config_1d735a37_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
