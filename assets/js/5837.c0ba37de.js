...
/* harmony import */ var _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(51285);
...
/* harmony import */ var _logger_8eaa31ac_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(86386);
...
const DyteDialogManager = class {
  constructor(hostRef) {
    ...
    this.meeting = undefined;
    this.config = _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_8__.d;
        ...
        if (parsedMessage.type === 'text') {
          if (notifications.chat) {
            this.add({
              id: `message-${Math.random().toString(36)}`,
              icon: this.iconPack.chat,
              message: `${parsedMessage.displayName}: ${(0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_16__.s)(parsedMessage.message, 20)}`,
