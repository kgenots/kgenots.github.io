...
/* harmony import */ var _config_1d735a37_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(59489);
/* harmony import */ var _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(51285);
...
const DyteUiProvider = class {
  constructor(hostRef) {
    ...
    this.size = undefined;
    this.config = _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_2__.d;
  ...
  async meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config } = (0,_config_1d735a37_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      if (this.config === _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_2__.d) {
        // only override the config if the object is same as defaultConfig
        // which means it's a different object passed via prop
        this.config = Object.assign(Object.assign(Object.assign({}, _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_2__.d), config), { designTokens: Object.assign(Object.assign({}, _default_ui_config_7632585b_js__WEBPACK_IMPORTED_MODULE_2__.d.designTokens), config.designTokens) });
      }
    }
    if (this.applyDesignSystem &&
      ((_a = this.config) === null || _a === void 0 ? void 0 : _a.designTokens) != null &&
      typeof document !== 'undefined') {
      (0,_config_1d735a37_js__WEBPACK_IMPORTED_MODULE_1__.p)(document.documentElement, this.config.designTokens);
    }
