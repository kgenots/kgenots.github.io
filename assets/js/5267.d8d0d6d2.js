...
const DyteMessageView = class {
  ...
  renderActions() {
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-menu", { placement: "top-end", offset: 1 }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { slot: "trigger", class: "actions" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_down })), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-menu-list", null, this.actions.map((action) => ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-menu-item", { onClick: () => this.onAction.emit(action.id) }, action.icon && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: action.icon, slot: "start" }), action.label))))));
  }
  render() {
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: { 'message-wrapper': true, [this.viewType]: true } }, !this.hideAvatar && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("aside", { class: "avatar" }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-avatar", { participant: { name: this.authorName, picture: this.avatarUrl }, size: "sm" }))), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "message" }, !this.hideAuthorName && (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "header" }, this.authorName), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: { body: true, bubble: this.variant === 'bubble' } }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null), !this.hideMetadata && !!this.time && ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "metadata", title: (0,_date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_4__.f)(this.time) }, (0,_date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_4__.e)(this.time, new Date(Date.now())))), this.actions.length !== 0 && this.renderActions())))));
  }
};
