...
/* harmony import */ var _store_01c79590_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(99126);
...
const DyteParticipantTile = class {
  constructor(hostRef) {
    ...
    this.tileLoad = (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "tileLoad", 7);
    this.tileUnload = (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "tileUnload", 7);
    this.participantVideoUpdate = (p) => {
  ...
  participantsChanged(participant) {
    ...
    if (participant.id === self.id)
      ...
      this.meeting.participants.joined.addListener('videoUpdate', this.participantVideoUpdate);
  ...
  isMirrored() {
    ...
    if (this.participant != null) {
      if (this.isSelf()) {
        const states = this.states || _store_01c79590_js__WEBPACK_IMPORTED_MODULE_1__.s;
  ...
  render() {
    ...
    const defaults = {
      ...
      size: this.size,
      states: this.states || _store_01c79590_js__WEBPACK_IMPORTED_MODULE_1__.s,
      config: this.config,
      iconPack: this.iconPack,
      t: this.t,
    };
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: { hideAvatar: this.videoState.videoEnabled } }, (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("video", { ref: (el) => this.onVideoRef(el), class: {
