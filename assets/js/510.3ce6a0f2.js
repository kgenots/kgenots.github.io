...
const DyteConfirmationModal = class {
  constructor(hostRef) {
    ...
    this.close = () => {
      ...
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_3__.s.activeConfirmationModal = { active: false };
      this.states.activeConfirmationModal.onClose(this.stateUpdate, _store_01c79590_js__WEBPACK_IMPORTED_MODULE_3__.s, this.meeting);
    };
    this.onConfirmation = async () => {
      this.stateUpdate.emit({ activeConfirmationModal: { active: false } });
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_3__.s.activeConfirmationModal = { active: false };
      this.states.activeConfirmationModal.onClick(this.stateUpdate, _store_01c79590_js__WEBPACK_IMPORTED_MODULE_3__.s, this.meeting);
    };
