  ...
  constructor(hostRef) {
    ...
    this.onParticipantTileLoad = (event) => {
      ...
      if (!participant || !videoElement)
        return;
      this.meeting.participants.pip.addSource(participant.id, videoElement, participant.videoEnabled, false, (_a = participant.name) !== null && _a !== void 0 ? _a : (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_7__.g)(participant.name));
