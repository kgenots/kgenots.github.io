...
const DyteBreakoutRoomsManager = class {
  constructor(hostRef) {
    ...
    this.enableConfirmationModal = (modalType = 'start-breakout') => {
      ...
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomsManager = { active: false };
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_3__.s.activeConfirmationModal = activeConfirmationModal;
    };
    this.close = () => {
      var _a;
