...
/* harmony import */ var _default_ui_config_f87e0ba7_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(71783);
...
const DyteChat = class {
  constructor(hostRef) {
    ...
    this.onChannelCreateClicked = () => {
      ...
      _store_01c79590_js__WEBPACK_IMPORTED_MODULE_8__.s.activeChannelCreator = true;
    };
  ...
  renderComposerUI() {
    ...
    return ((0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-chat-composer-view", Object.assign({ message: message, storageKey: (_a = this.selectedChannelId) !== null && _a !== void 0 ? _a : `draft-${this.selectedChannelId}`, quotedMessage: quotedMessage, isEditing: !!this.editingMessage, canSendTextMessage: this.isTextMessagingAllowed(), canSendFiles: this.isFileMessagingAllowed(), disableEmojiPicker: !!((_c = (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.__internals__) === null || _c === void 0 ? void 0 : _c.features.hasFeature(_flags_ef1a782f_js__WEBPACK_IMPORTED_MODULE_5__.F.DISABLE_EMOJI_PICKER)), inputTextPlaceholder: this.t('chat.message_placeholder'), onNewMessage: this.onNewMessageHandler, onEditMessage: this.onEditMessageHandler, onEditCancel: () => (this.editingMessage = null), onQuotedMessageDismiss: () => (this.replyMessage = null) }, uiProps), (0,_index_861bcf4b_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "chat-addon", slot: "chat-addon" })));
  }
  renderFullChat() {
