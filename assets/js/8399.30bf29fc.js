...
/* harmony import */ var _size_d48d31c8_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9245);
...
/* harmony import */ var _default_icon_pack_307ffa7c_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(48724);
/* harmony import */ var _keysIn_8bf552ee_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(34166);
/* harmony import */ var _isObjectLike_0d1a05d5_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(9079);
/* harmony import */ var _breakout_rooms_34bb7ea2_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(52732);
/* harmony import */ var _flags_ef1a782f_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(2079);
...
const DyteUiProvider = class {
  constructor(hostRef) {
    ...
    this.joinRoom = true;
    this.isReady = false;
    this.iconPack = _default_icon_pack_307ffa7c_js__WEBPACK_IMPORTED_MODULE_7__.d;
  }
  async iconPackUrlChanged(url) {
    this.iconPack = await (0,_size_d48d31c8_js__WEBPACK_IMPORTED_MODULE_3__.g)(url);
  }
  async meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config } = (0,_config_784a655d_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      if (this.config === _default_ui_config_f87e0ba7_js__WEBPACK_IMPORTED_MODULE_2__.d) {
        // only override the config if the object is same as defaultConfig
        // which means it's a different object passed via prop
        this.config = Object.assign(Object.assign(Object.assign({}, _default_ui_config_f87e0ba7_js__WEBPACK_IMPORTED_MODULE_2__.d), config), { designTokens: Object.assign(Object.assign({}, _default_ui_config_f87e0ba7_js__WEBPACK_IMPORTED_MODULE_2__.d.designTokens), config.designTokens) });
      }
    }
  ...
  handleResize() {
    this.size = (0,_size_d48d31c8_js__WEBPACK_IMPORTED_MODULE_3__.a)(this.hostEl.clientWidth);
  }
  render() {
    if (!this.isReady)
      return null;
